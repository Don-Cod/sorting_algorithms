...
/**
 * _swap - this one swaps two values in an array
 *
 * @array: data to sort
 * @i: first value
 * @j: second value
...
/**
 * partition - this one sorts a partition of data in relation to a pivot
 *
 * @array: data to sort
 * @min: Left wall
 * @max: right wall
...
/**
 * quicksort - it sorts an array of integers in ascending order using the
...
/**
 * quick_sort_hoare - this one sorts an array
